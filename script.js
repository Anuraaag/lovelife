...
function page_change(val) {
    ...
    if (val == 'register') {
        window.location = "index.php?p=register";
    }
...
// function change_pswd_visibility_login() {
...
function change_pswd_visibility(val) {
    if (val == "register") {
        var x = document.getElementById("pswd");
        var y = document.getElementById("pswd_vis");
    ...
    if (x.type === "password") {
        x.type = "text";
        y.src = "./includes/images/visible.png";

    }
    else {
        x.type = "password";
        y.src = "./includes/images/invisible.png";
    }

}

// register.php scripts ends

// forget_pswd.php scripts starts
...
function validateForgetPswd()
{
    ...
    let strfield=forget_pswd_form.email_mobile;
    if(strfield.value=="")
    {
        str+="Please enter mobile or email id.";
        document.getElementById("validation_div").style.display="inline";
    }

    if(str=="")
    {
    document.getElementById("forget_pswd_div").style.display='none';
    document.getElementById("pswd_reset").style.display="block";
    }
